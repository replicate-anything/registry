# Marginal effects of conditions by party — Public support for global vaccine sharing in the COVID-19 pandemic: Evidence from Germany
...
make_fig_6(utils::read.csv("../data/fig_1.csv", stringsAsFactors = FALSE))
